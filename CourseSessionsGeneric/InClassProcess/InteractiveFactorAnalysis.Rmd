...
<html lang="en">
  ...
  <title>INSEADAnalytics/InteractiveFactorAnalysis.Rmd at master · InseadDataAnalytics/INSEADAnalytics</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjQ2MTgxNzAyOmIxYzc2N2Q0YWVjMjQwYjQzNzJmMjUwY2M4Yzg3ZWYyMTk3ZGMxYWZmNmE0M2Q5ZGVmOGFkYThhOTQ4ODNjODE=--d035977e68f5517109ae5e3788af3adadad7f3e5">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="CE45:33C0:17FDDC5:29F387A:5A7FB179" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="miroslavsala">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta content="6098619" name="octolytics-dimension-user_id" /><meta content="InseadDataAnalytics" name="octolytics-dimension-user_login" /><meta content="15819896" name="octolytics-dimension-repository_id" /><meta content="InseadDataAnalytics/INSEADAnalytics" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="15819896" name="octolytics-dimension-repository_network_root_id" /><meta content="InseadDataAnalytics/INSEADAnalytics" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/InseadDataAnalytics/INSEADAnalytics/blob/master/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd" data-pjax-transient>
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/InseadDataAnalytics/INSEADAnalytics/search" class="js-site-search-form" data-scoped-search-url="/InseadDataAnalytics/INSEADAnalytics/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/InseadDataAnalytics/INSEADAnalytics/blob/master/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="n8s4yjcqa6vLnS8xBePwA6qTXOWrhqB3HuI5LuJ3Qsjvg4fVbhxXzhIhghtGrttj5mJQbfVZzQKDcguUUQlzQg==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="0iwq7+iKq01U7o6bo7m5F/CXGtTBCNApI3UjocHjyYGiZJXwsbyXKI1SI7Hg9JJ3vGYWXJ/XvVy+5REbcp34Cw==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="/ZBJIyrw11I2oeCuMCN3ORZ3klTpMEQU5J+5QtfeS/YToOCmgehrLGZjzBhcHBv83xhy1sSdqDTy5/1omiHofw==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="15819896" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/InseadDataAnalytics/INSEADAnalytics/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="W0uIEnuB9dEJE7lzco+ZKbhry2LcctnL3pcpeGKzF4Hfn09vvcsplD0hXjGrMAKY/nRwTV4b2BGC1tqpRBxmMA==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/InseadDataAnalytics/INSEADAnalytics/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="d0JIg2d8cSl5zSJlWAxLqNxeACVwQEb4vqDhTjL6Wr+W4va61lUZf5p+/AszFvd5MXqHiEBHf6lyKDe0bms/MQ==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/InseadDataAnalytics/INSEADAnalytics/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="8aRcOiDeDuyuQsyDXOlUEuaGYIgMwlr7LIH5hggBw2fQqHInZyFBTMraKUhZvsREC9nO8FIAK0L7V+VYB4QVpw==" /></div>
            <button
                type="submit"
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a href="/InseadDataAnalytics/INSEADAnalytics/blob/ff194a91c6e4d003520685e8f20c7f2e138c054d/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:f6643e851e938a71987cbf0201b47a76 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/InseadDataAnalytics/INSEADAnalytics/blob/gh-pages/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd"
               data-name="gh-pages"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/InseadDataAnalytics/INSEADAnalytics/blob/master/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/InseadDataAnalytics/INSEADAnalytics" data-pjax="true"><span>INSEADAnalytics</span></a></span></span><span class="separator">/</span><span class="js-path-segment"><a href="/InseadDataAnalytics/INSEADAnalytics/tree/master/CourseSessions" data-pjax="true"><span>CourseSessions</span></a></span><span class="separator">/</span><span class="js-path-segment"><a href="/InseadDataAnalytics/INSEADAnalytics/tree/master/CourseSessions/Sessions23" data-pjax="true"><span>Sessions23</span></a></span><span class="separator">/</span><strong class="final-path">InteractiveFactorAnalysis.Rmd</strong>
    </div>
  </div>


  <include-fragment class="commit-tease" src="/InseadDataAnalytics/INSEADAnalytics/contributors/master/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/InseadDataAnalytics/INSEADAnalytics/raw/master/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/InseadDataAnalytics/INSEADAnalytics/blame/master/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/InseadDataAnalytics/INSEADAnalytics/commits/master/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/InseadDataAnalytics/INSEADAnalytics/edit/master/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="VwYp9nfLImlLsaQhneJpoGTIIRhDkrHe9KjB2DgZBNWsLE4eMZvgA0NC/j4VK4IfOOY9laVfRaLuhddQ3pyMUg==" /></div>
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Edit the file in your fork of this project" data-hotkey="e" data-disable-with>
              <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/InseadDataAnalytics/INSEADAnalytics/delete/master/CourseSessions/Sessions23/InteractiveFactorAnalysis.Rmd" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wOzb01IXO5Qljehm+nfPIWyGwWv8xMaZvn1IjHMWkP9p4z2VcYt0c0hWqMM7SGQDhr4sK2jb2biJ2T6lL6a+6A==" /></div>
  ...
  <tbody>
  <tr>
  <td><div>Derived Attributes and Dimensionality Reduction: Interactive Tool</div></td>
...
<pre lang="{r"><code>source("../../AnalyticsLibraries/library.R")
...
<h2><a href="#factor-analysis-in-6-steps" aria-hidden="true" class="anchor" id="user-content-factor-analysis-in-6-steps"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Factor Analysis in 6 steps</h2>
<p>This tool follows the 6 steps for factor analysis outlined in the <a href="http://inseaddataanalytics.github.io/INSEADAnalytics/Report_s23.html" rel="nofollow">Derived Attributes and Dimensionality Reduction</a> reading of the course.</p>
<p>First we load the data (<code>data/MBAadmin.csv</code> by default):</p>
<pre lang="{r}"><code># Please ENTER the name of the file with the data used. The file should contain a matrix with one row per observation (e.g. person) and one column per attribute.
...
<p>We also need to select which variables to consider for factor analysis (<code>r MAX_VARIABLES</code> at most):</p>
<pre lang="{r}"><code># Please ENTER then original raw attributes to use. 
...
<p>Here is how the first <code>r SAMPLE_ROWS</code> rows look like:</p>
<pre lang="{r}"><code>renderFormattable(dformat(head(ProjectDataFactorX(), SAMPLE_ROWS)))
</code></pre>
<h3><a href="#step-1-confirm-data-is-metric" aria-hidden="true" class="anchor" id="user-content-step-1-confirm-data-is-metric"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Step 1: Confirm data is metric</h3>
<p>The data we use here have the following descriptive statistics:</p>
<pre lang="{r}"><code>renderFormattable(dformat(round(my_summary(ProjectDataFactorX()), 2)))
</code></pre>
<h3><a href="#step-2-scale-the--data" aria-hidden="true" class="anchor" id="user-content-step-2-scale-the--data"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Step 2: Scale the  data</h3>
<p>Select variables to standardize:</p>
<pre lang="{r}"><code># Please enter the variables you would like to standardize: 
...
<p>These are the summary statistics of the scaled dataset:</p>
<pre lang="{r}"><code>renderFormattable(dformat(round(my_summary(ProjectDataFactorStandardized()), 2)))
</code></pre>
<h3><a href="#step-3--check-correlations" aria-hidden="true" class="anchor" id="user-content-step-3--check-correlations"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Step 3:  Check correlations</h3>
<p>This is the correlation matrix of the original variables we use for factor analysis:</p>
<pre lang="{r}"><code>renderFormattable(dformat(round(cor(ProjectDataFactorStandardized()), 2)))
</code></pre>
<h3><a href="#step-4-choose-number-of-factors" aria-hidden="true" class="anchor" id="user-content-step-4-choose-number-of-factors"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Step 4: Choose number of factors</h3>
<p>This is the Variance Explained table, using all data selected for factor analysis:</p>
<pre lang="{r}"><code>Variance_Explained_TableX &lt;- eventReactive(ProjectDataFactorStandardized(), {
...
<p>Here is the <strong>scree plot</strong>:</p>
<pre lang="{r}"><code>tags$div(style='height:480px', renderC3({
...
<p>We now select the criterion to use for deciding how many factors to use:</p>
<pre lang="{r}"><code># Please ENTER the selection criterions for the factors to use. 
...
<h3><a href="#step-5-interpret-the-factors" aria-hidden="true" class="anchor" id="user-content-step-5-interpret-the-factors"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Step 5: Interpret the factors</h3>
<p>We can now use a rotation to get easier to interpret results:</p>
<pre lang="{r}"><code># Please ENTER the rotation eventually used (e.g. "none", "varimax", "quartimax", "promax", "oblimin", "simplimax", and "cluster" - see help(principal)). Defauls is "varimax"
...
<p>For our data, the <code>r renderText(max(factors_selectedX()))</code> selected factors look as follows after the <code>r renderText(input$rotation_used)</code> rotation:</p>
<pre lang="{r}"><code>Rotated_FactorsX &lt;- eventReactive({ 
  input$rotation_used
  factors_selectedX()
...
<p>We can also "supress" loadings with small values. Please select the minimum values to display:</p>
<pre lang="{r}"><code># Please enter the minimum number below which you would like not to print - this makes the readability of the tables easier. Default values are either 10e6 (to print everything) or 0.5. Try both to see the difference.
sliderInput("MIN_VALUE", "", min=0, max=1, value=0.5)
</code></pre>
<p>Here are our rotated factors:</p>
<pre lang="{r}"><code>Rotated_Factors_thresX &lt;- eventReactive({
  input$MIN_VALUE
  Rotated_FactorsX()
}, {
...
<h3><a href="#step-6-save-factor-scores" aria-hidden="true" class="anchor" id="user-content-step-6-save-factor-scores"><svg aria-hidden="true" class="octicon octicon-link" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Step 6: Save factor scores</h3>
<p>For our data, using the rotated factors we selected, we can create a new dataset where our observations are as follows (for the first <code>r SAMPLE_ROWS</code> observations):</p>
<pre lang="{r}"><code>NEW_ProjectDataX &lt;- eventReactive({
  input$rotation_used
  factors_selectedX()
  ProjectDataFactorStandardized()
},{
...
<p>We now can replace our original data with the new ones and continue our analysis. For example, we can now visualize our original data using only the newly derived attributes:</p>
<pre lang="{r}"><code>tags$div(style='height:480px', renderC3({
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.23836s from unicorn-1205048551-mptqj">GitHub</span>, Inc.</li>
